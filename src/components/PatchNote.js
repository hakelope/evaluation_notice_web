...
function PatchNote() {
  const patches = [
    ...
    },
    {
      ...
      date: '2025-05-05',
      changes: [
        '수행평가 추가 시 반 별 일정 변경 기능 개선',
        '기본 날짜 토글 기능 추가',
        '필수 입력란 강조 효과 추가',
        '학년 배지 CSS 충돌 문제 해결',
        '수행평가 추가 및 수정 시 관리자 페이지로 리다이렉트되도록 수정',
        '수행평가 검색 페이지의 태블릿 환경 가독성 개선',
        '캘린더-일정 상세보기 박스의 태블릿 환경 크기 개선',
        '수행평가 검색 페이지와 캘린더 페이지가 과제 완료 상태를 공유하도록 수정',
        '메인 페이지 양식 개선 및 검색하기 페이지 이동 버튼 추가',
        '크레딧 추가',
        '수행평가 검색 페이지에 날짜 정렬 기능 추가 (가까운 순/먼 순)',
        '수행평가 상세 페이지의 준비물 목록 가독성 개선',
        '수행평가 상세 페이지의 표시 개선',
        '평가 유형별 색상 구분 추가 (수행평가 기간: 초록색, 제출 마감일: 주황색, 실시일: 파란색)',
        '수행평가 검색 페이지 및 최근 변경사항 페이지에 필터링 기능 추가',
        '최근 변경사항 css 충돌 문제 해결'
      ]
    },
    {
      version: '1.4.0',
